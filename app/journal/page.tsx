  ...
  return (
    <main className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image src="/images/background.png" alt="Günlük arka planı" fill className="object-cover" sizes="100vw" />
      </div>
        ...
        <div className="text-center mb-8">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-slate-800">Günlüğüm</h1>
            </div>
          </motion.div>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Düşüncelerini ve duygularını kaydet. Günlük tutmak, kendini daha iyi anlamanın ve duygusal farkındalığını
